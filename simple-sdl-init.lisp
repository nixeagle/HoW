...
(defun start-how ()
  (sdl:with-init (sdl:sdl-init-video )
	...
	(:key-down-event (:key key)
			 ...
			 (when (sdl:key= key :sdl-key-0) (setf fire-cell 0))
			 (when (sdl:key= key :sdl-key-1) (setf fire-cell 1))
			 (when (sdl:key= key :sdl-key-2) (setf fire-cell 2))
			 (when (sdl:key= key :sdl-key-3) (setf fire-cell 3))
			 (when (sdl:key= key :sdl-key-4) (setf fire-cell 4))
			 (when (sdl:key= key :sdl-key-5) (setf fire-cell 5))
			 (when (sdl:key= key :sdl-key-6) (setf fire-cell 6))
			 (when (sdl:key= key :sdl-key-7) (setf fire-cell 7))
			 (when (sdl:key= key :sdl-key-8) (setf fire-cell 8))
			 (when (sdl:key= key :sdl-key-9) (setf fire-cell 9))
			 (when (sdl:key= key :sdl-key-w) (setf fire-cell 10))
			 (when (sdl:key= key :sdl-key-e) (setf fire-cell 11))
			 (when (sdl:key= key :sdl-key-r) (setf fire-cell 12))
			 (when (sdl:key= key :sdl-key-t) (setf fire-cell 13))
			 (when (sdl:key= key :sdl-key-y) (setf fire-cell 14))
			 (when (sdl:key= key :sdl-key-u) (setf fire-cell 15)))
	(:idle ()
